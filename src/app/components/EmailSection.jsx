                ...
                {emailSubmitted ? (
                    ...
                    <form className='flex flex-col' onSubmit={handleSubmit}>
                        <div className='mb-6'>
                            <label htmlFor="email" className='text-[#A0A0A0] block mb-2 text-sm font-medium'>Your email</label>
                            <input 
                                className='bg-gray-400 border border-[#33353F] placeholder-gray-900 text-gray-100 text-sm rounded-lg block w-full p-2.5' 
                                type='email' name='email' id='email' required placeholder='abc@gmail.com' 
                            />
                        </div>
                        <div className='mb-6'>
                            <label htmlFor="subject" className='text-[#A0A0A0] block mb-2 text-sm font-medium'>Subject</label>
                        ...
                        <div className='mb-6'>
                            ...
                            <textarea 
                                className='bg-gray-400 border border-[#33353F] placeholder-gray-900 text-gray-100 text-sm rounded-lg block w-full p-2.5' 
                                name='message' id='message' rows="4" required placeholder='Your message here...'
                            ></textarea>
                        </div>
                        <button
                            type='submit'
                            disabled={isPending}
                            className='bg-[#2A2D30] hover:bg-[#121416] text-white font-medium py-2.5 px-5 rounded-lg w-full disabled:opacity-50'>
